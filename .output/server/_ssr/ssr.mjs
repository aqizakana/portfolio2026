import "../_runtime.mjs";
import { d as require_jsx_runtime, f as require_react, i as RouterProvider, t as renderRouterToStream } from "../_libs/@tanstack/react-router+[...].mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-ETiN3llx.mjs");
...
async function loadEntries() {
	const routerEntry = await import("./router-K4niHJRS.mjs");
	return {
		startEntry: await import("./start-B5xe8VBT.mjs"),
		routerEntry
	};
}
function getEntries() {
